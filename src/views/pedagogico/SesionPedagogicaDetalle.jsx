...
import {
  ...
  Visibility, Info, Replay, NoteAdd, Lock, Warning
...
const SesionPedagogicaDetalle = () => {
  ...
  const handleTabChange = (event, newValue) => {
    ...
    if (newValue === 5 && !observacionesLoaded) {
      fetchObservaciones();
    }
  };
  ...
  const fetchObservaciones = async () => {
    ...
    try {
      const res = await observacionesService.getObservacionesSesion(id, 'pedagogica', false);
      ...
      >
        ...
        <CardContent sx={{ p: { xs: 2, md: 3 } }}>
          ...
          >
            ...
            <Tab icon={<NoteAdd />} label="Observaciones" {...a11yProps(5)} />
          </Tabs>
        </CardContent>
      </Card>
        ...
        <DialogContent>
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2, mt: 1 }}>
            <TextField
              ...
              sx={greenOutlineSX}
            />
            <FormControl fullWidth sx={greenOutlineSX}>
