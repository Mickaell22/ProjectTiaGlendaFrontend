...
import PacienteForm from './PacienteForm'; // ✅ Importamos el formulario de paciente
  ...
  return (
    <PageContainer title="Vertical Form" description="this is Vertical Form page">
      ...
      <Grid container spacing={3}>
        ...
        {/* Sección: Multi Column with Form Separator */}
        <Grid item xs={12}>
